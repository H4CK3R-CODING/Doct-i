    ...
    <div className='flex flex-col'>
      ...
      <div className='relative w-full'>
        ...
        }}/>
        {
          ...
          }} className='absolute top-0 cursor-pointer right-3 p-2'>{passvisible ? <LiaEye className='text-xl' /> : <LiaEyeSlash className='text-xl' />}</span> : ""
        }
        {
          detail.id == "otp" ? <span onClick={()=>{
            
          }} className='absolute top-0 font-semibold right-3 p-2 text-heading'><Timer/></span> : ""
        }
      </div>
